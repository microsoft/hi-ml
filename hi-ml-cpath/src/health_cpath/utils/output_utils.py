...
class DeepMILOutputsHandler:
    ...
    def set_ihc_slides_dataset_for_plots_handlers(self, ihc_slides_dataset: Optional[SlidesDataset]) -> None:
        self.test_plots_handler.ihc_slides_dataset = ihc_slides_dataset
        self.val_plots_handler.ihc_slides_dataset = ihc_slides_dataset
