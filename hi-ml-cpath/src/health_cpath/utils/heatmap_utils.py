...
def location_selected_tiles(tile_coords: np.ndarray,
                            ...
                            scale_factor: int = 1,
                            should_upsacle_coords: bool = True) -> np.ndarray:
    ...
    :param should_upsacle_coords: If True, the tile coordinates are upscaled by the scale factor before substructing
