...
from health_cpath.utils.crop_conversion_config import create_tiff_conversion_config_from_args    # noqa


def main() -> None:
    config = create_tiff_conversion_config_from_args()
    logging_to_stdout()
