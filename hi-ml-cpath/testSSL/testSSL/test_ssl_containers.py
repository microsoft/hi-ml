...
def test_ssl_container_cifar10_resnet_simclr() -> None:
    ...
    """
    model_namespace_simclr = "health_cpath.SSL.configs.CIFAR10SimCLR"
    ...
    model_namespace_cifar = "health_cpath.SSL.configs.SSLClassifierCIFAR"
...
def test_load_ssl_container_cifar10_cifar100_resnet_byol() -> None:
    ...
    """
    model_namespace_byol = "health_cpath.SSL.configs.CIFAR10CIFAR100BYOL"
...
def test_ssl_container_rsna() -> None:
    """
    ...
    model_namespace_byol = "health_cpath.SSL.configs.NIH_RSNA_BYOL"
    args = common_test_args + [f"--model={model_namespace_byol}",
    ...
    model_namespace_cxr = "health_cpath.SSL.configs.CXRImageClassifier"
...
def test_simclr_num_nodes() -> None:
    ...
    LR scheduler.
    """
    with mock.patch("health_ml.deep_learning_config.TrainerParams.num_gpus_per_node", return_value=1):
