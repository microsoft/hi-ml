...
def _assert_correct_bag_sizes(
    datamodule: HistoDataModule, max_bag_size: int, max_bag_size_inf: Optional[int], true_bag_sizes: List[int]
) -> None:
...
def test_slides_datamodule_different_batch_sizes(
    mock_panda_slides_root_dir: Path,
    batch_size: int,
    batch_size_inf: Optional[int],
) -> None:
    datamodule = PandaSlidesDataModule(
        root_path=mock_panda_slides_root_dir,
