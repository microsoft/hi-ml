...
def submit_to_azure_if_neededOLD(  # type: ignore # missing return since we exit
    ...
    print(f"run_config.docker.use_docker == {run_config.docker.use_docker}")
    print(f"run_config.environment.python.user_managed_dependencies == {run_config.environment.python.user_managed_dependencies}")
