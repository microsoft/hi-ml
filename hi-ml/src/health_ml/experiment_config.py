...
class ExperimentConfig(param.Parameterized):
    ...
    azureml: bool = param.Boolean(
        False, doc="If True, submit the executing script to run on AzureML.")
    tag: str = param.String(
        doc="A string that will be used as the display name of the run in AzureML.")
