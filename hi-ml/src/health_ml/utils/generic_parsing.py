...
from health_azure.utils import is_private_field_name

from health_ml.utils.type_annotations import T
...
def parse_args_and_add_yaml_variables(parser: argparse.ArgumentParser,
    ...
    :return: The parsed arguments, and overrides
    """
    return parse_arguments(parser, fail_on_unknown_args=fail_on_unknown_args)
