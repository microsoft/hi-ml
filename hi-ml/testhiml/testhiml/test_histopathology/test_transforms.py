...
from health_ml.data.histopathology.datasets.default_paths import TCGA_CRCK_DATASET_DIR
...
def _test_cache_and_persistent_datasets(base_dataset: TorchDataset,
    ...
    cache_dir = TEST_OUTPUTS_PATH / cache_subdir
