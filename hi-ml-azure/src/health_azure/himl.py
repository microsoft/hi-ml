...
def submit_run_v2(workspace: Optional[Workspace],
    ...
    :param display_name: The name that will be displayed in the AML UI. If not provided or set to an empty string,
        the unique run ID will be used as the display name.
...
def submit_run(workspace: Workspace,
    ...
    :param display_name: The name that will be displayed in the AML UI. If not provided, the unique run ID will be
