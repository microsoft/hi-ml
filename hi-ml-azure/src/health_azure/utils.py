...
def generate_unique_environment_name_from_directory(
    folder_path: Path,
    ...
    generated by concatenating the contents of all files in the given folder and hashing the result.

    :param folder_path: The path to the folder containing the files to be hashed.
    ...
    overall_hash = hash_object.hexdigest()[:num_hash_digits]
...
def create_python_environment(
    ...
    unique_env_name = generate_unique_environment_name_from_description(env_description_string)
...
def create_python_environment_v2(
    ...
    unique_env_name = generate_unique_environment_name_from_description(environment_description_string)
