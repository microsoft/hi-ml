...
#  ------------------------------------------------------------------------------------------
"""
Utility functions for interacting with Azure AI ML
"""
import json
import logging
import os
...
from typing import (Any, Callable, Dict, Generator, Iterable, List, Optional, Set, Tuple, Type, TypeVar,
                    Union)
...
def aml_workspace_for_unittests() -> Workspace:
    ...
    if config_json is not None:
        ...
        client = get_workspace_client(subscription_id=subscription_id, resource_group=resource_group,
        workspace_name=workspace_name)
        workspace = retrieve_workspace_from_client(client)
        return workspace
