...
def aggregate_hyperdrive_metrics(run_id: str, workspace: Workspace) -> pd.DataFrame:
    """
    ...
    :param workspace: An AzureML Workspace object which contains the run with this id
    ...
    for child_run in run.get_children():
        ...
        child_run_crossval_split = json.loads(child_run.tags.get('hyperparameters')).get('cross_validation_split_index')
