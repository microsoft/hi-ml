...
from health_multimodal.image.model.model import MinimalImageModel
...
class ImageInferenceEngine:
    ...
    def __init__(self, image_model: MinimalImageModel, transform: Compose):
        """
        ...
        assert isinstance(image_model, MinimalImageModel), f"Expected a MinimalImageModel, got {type(image_model)}"
