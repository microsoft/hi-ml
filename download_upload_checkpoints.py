...
if __name__ == "__main__":
    ...
    experiment_name = "simclr_8_gpus"
    old_run = f"{experiment_name}:CRCK_SimCLR_1647951559_d2a19df5"
    ...
    old_workspace_config_json = root_folder / "config.json"
    new_workspace_config_json = root_folder / "new_config.json"
    ...
    download_files_from_run_id(run_id=old_run, workspace_config_path=old_workspace_config_json,
    ...
    new_run = create_aml_run_object(experiment_name=experiment_name, workspace_config_path=new_workspace_config_json)
