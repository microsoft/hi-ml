...
from SSL.datamodules_and_datasets.transform_pipeline import create_transforms_from_config
...
class CIFARTrainTransform(SimCLRTrainDataTransform):
    """
...
class CIFARLinearHeadTransform(SimCLRTrainDataTransform):
    """
