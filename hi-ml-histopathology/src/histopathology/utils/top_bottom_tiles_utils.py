    ...
    def gather_top_bottom_tiles_for_top_bottom_slides(self) -> None:
        ...
        if torch.distributed.is_initialized():
            ...
            if world_size > 1:
                ...
                final_top_slides_heaps = self.gather_shallow_slides_heaps(
                    world_size, shallow_top_slides_heaps)
                final_bottom_slides_heaps = self.gather_shallow_slides_heaps(
                ...
                top_tiles: TileDict = self.gather_dictionaries(
                    world_size, top_slides_top_tiles)  # type: ignore
                bottom_tiles: TileDict = self.gather_dictionaries(
                    world_size, top_slides_bottom_tiles)  # type: ignore
                self.update_shallow_top_slides_heaps_with_top_bottom_tiles(
                ...
                self.update_shallow_bottom_slides_heaps_with_top_bottom_tiles(
                    top_tiles, bottom_tiles)
