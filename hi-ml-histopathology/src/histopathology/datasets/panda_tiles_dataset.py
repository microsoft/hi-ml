...
class PandaTilesDataset(TilesDataset):
    ...
    N_CLASSES = 6
    _RELATIVE_ROOT_FOLDER_5X = "panda_tiles_level1_224"
    _RELATIVE_ROOT_FOLDER_20X = "panda_tiles_level0_224"
    ...
    def __init__(self,
        ...
        """
        super().__init__(root=Path(root) / self._RELATIVE_ROOT_FOLDER_20X,
